...
@section('content')
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    ...
                                    <form role="form" action="{{route('postedit-supplier',$supplier->id)}}" method="POST"enctype="multipart/form-data">
                                     {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Tên Nhà Cung Cấp"required=""name="txtname"value="{{$supplier->name}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-mail" aria-hidden="true"></i></span>
                                                        <input type="email" class="form-control" placeholder="Email"required=""name="txtemail"value="{{$supplier->email}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <ul  class="dropdown-header-top author-log dropdown-menu animated zoomIn"> 
                                                         <textarea type="text" class="form-control" name="txtdescription"id="contents">{{$supplier->description}}</textarea>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="type" class="form-control" placeholder="Địa Chỉ"required=""name="txtaddress"value="{{$supplier->address}}">
                                                    </div>
                                                    <select class="form-control pro-edt-select form-control-primary"name="txtstatus">
															<option value="1"<?php if($supplier->status == 1) echo 'selected';   ?>>Trạng Thái: Kích Hoạt</option>
															<option value="0"<?php if($supplier->status == 0) echo 'selected';   ?>>Trạng Thái: Tạm Khóa</option>
													</select>
                                                </div>
                                            </div>
                                        </div>
