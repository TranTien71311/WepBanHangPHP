...
@section('content')
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    ...
                                    <form role="form" action="{{route('postadd-product')}}" method="POST"enctype="multipart/form-data">
                                     {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Tên Sản Phẩm"required=""name="txtname">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <ul  class="dropdown-header-top author-log dropdown-menu animated zoomIn"> 
                                                         <textarea type="text" class="form-control" name="txtcontent"id="contents"></textarea>
                                                        </ul>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Giảm Giá"required=""name="txtdiscount">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                    <select class="form-control pro-edt-select form-control-primary"name="txtidcat">
                                                    @foreach($list_category as $cate)
															<option value="{{$cate->id}}">{{$cate->namecat}}</option>
                                                    @endforeach
													</select>
                                                    </div>
